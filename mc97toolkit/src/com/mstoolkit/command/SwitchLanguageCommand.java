...
public class SwitchLanguageCommand implements ICommand
{
    public void execute(JFrame frame)
    {
        ...
        if (redo)
            JOptionPane.showMessageDialog(frame, Const.RESWITCHLANGUAGE, Const.WARNING, 2);
        else if (success)
            JOptionPane.showMessageDialog(frame, Const.SWITCHLANGUAGESUCCESS, Const.INFORMATION, 1);
        else
            JOptionPane.showMessageDialog(frame, Const.SWITCHLANGUAGEFAILED, Const.ERROR, 0);
    }
}
