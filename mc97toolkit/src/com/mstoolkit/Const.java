...
public class Const
{
    ...
    static
    {
        ...
        name = new String[] { useChinese ? "编号" : "No.", useChinese ? "文件名" : "File Name", "文件类型", "版本", useChinese ? "标识" : "ID", useChinese ? "日期" : "Date", useChinese ? "级别" : "Level",
                ...
                "zoe", "numSpeed", "hzinis", "zinis", "occam", "lclicks", "dclicks", "rclicks", "qg", "flags", "markFlag", "holds","cloneR", "islands" ,"eventSize","mvsize","lcsize","lrsize","rcsize","rrsize","mcsize","mrsize"};
