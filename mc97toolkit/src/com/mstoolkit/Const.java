...
public class Const
{
    ...
    static
    {
        ...
        TITLE = useChinese ? "扫雷工具箱" : "Minesweeper Tool Kit";
        VERSION = "V0.72 Alpha";
        WELCOME = useChinese ? "欢迎使用扫雷工具箱" : "Welcome to use Minesweeper Tool Kit";
        AUTHOR = useChinese ? "作者：crazyks，感谢超级丹、石教授、击晕、技术帝以及扫雷网（Saolei.net）的全体成员！" : "Made by crazyks! Great thanks to Dan Zhou, Weiguo Shi,  Jiyun Wang and all member of Saolei.net.";
        DIATITLE = useChinese ? "请选择一个有MVF文件的文件夹" : "Please choose a folder with MVF Files";
        NOTADIRECTORY = useChinese ? "不是一个文件夹" : "is not a directory!";
        CANNOTACCESS = useChinese ? "不可访问" : "can not access!";
        EMPTYFOLDER = useChinese ? "没有找到任何MVF文件，文件夹：" : "There is no any MVF file in";
        FOUNDMVF = useChinese ? "个MVF文件被检测到" : "MVF File(s) found in";
        ...
        GOTOSAOLEINET = useChinese ? "去扫雷网看看" : "Go to Saolei.net";
        GOTOAUTHORS = useChinese ? "去瞅瞅作者" : "Go to Author's Page";
        ...
        NOTHINGEXPORTED = useChinese ? "导不出任何东东！" : "Nothing can be exported!";
        ...
        DONOTINTERRUPT = useChinese ? "请不要终止统计！" : "CALCULATION NOT FINISHED! PlEASE DO NOT INTERRUPT!";
        EXPORTTO = useChinese ? "MVF信息导出至：" : "Export to";
        SUCCESS = useChinese ? "成功" : "Success!";
        LOADHISTORY = useChinese ? "加载history.inf文件" : "Load History File";
        FIXHISTORY = useChinese ? "修复history.inf文件" : "Fix History File";
        SWITCHLANGUAGE = useChinese ? "to English" : "使用中文";
        DEVELOPING = useChinese ? "开发中..." : "Developing...";
        SORRY = useChinese ? "抱歉" : "Sorry";
        FORBIDDEN = useChinese ? "此项功能禁止使用！" : "This function is forbidden to use!";
        ...
        CONTACTME = useChinese ? "欢迎任何意见和建议！\n联系我：crazyks@yeah.net" : "Welcome any comment or suggestion!\nContacts me: crazyks@yeah.net";
        OPENBROWSERFAILED = useChinese ? "打开网页失败" : "Open Browser Failed!";
        SWITCHLANGUAGESUCCESS = useChinese ? "切换语言成功，重启软件后生效~" : "Switch Language Success, It will be available after restart!";
        SWITCHLANGUAGEFAILED = useChinese ? "切换语言失败！" : "Switch Language Failed!";
        RESWITCHLANGUAGE = useChinese ? "重复操作，切换语言重启后生效！" : "Reswitch Language! It will be available after restart!";
        ...
        name = new String[] { useChinese ? "编号" : "No.", useChinese ? "文件名" : "File Name", "文件类型", "版本", useChinese ? "标识" : "ID", useChinese ? "日期" : "Date", useChinese ? "级别" : "Level",
                ...
                "zoe", "numSpeed", "hzinis", "zinis", "occam", "lclicks", "dclicks", "rclicks", "qg", "flags", "markFlag", "holds","cloneR", "islands" ,"eventSize","mvsize","lcsize","lrsize","rcsize","rrsize","mcsize","mrsize","wasteflags","firstLx","firstLy"};
        ...
        CHOOSEHISTORYFILE = useChinese ? "选择一个history.inf文件" : "Please choose a history.inf file";
        FINDHISTORYFILE = useChinese ? "开始解析History文件" : "Start Parsing histroy.inf";
        LOADHISTORYFAILED = useChinese ? "加载history.inf文件失败！" : "Load History File Failed!";
        DOYOUWANNAFIX = useChinese ? "文件貌似损坏，您打算修复此history.inf文件吗？" : "This file maybe broken. Do you wanna Fix this histroy.inf?";
        historyName = new String[] { useChinese ? "编号" : "No.", useChinese ? "级别" : "Level", useChinese ? "风格" : "Style", useChinese ? "时间" : "Time", useChinese ? "日期" : "Date", "3BV", "3BV/s",
                "Click/s", "RQP", "IOE", "L", "D", "R", "QG" };

        EXPORTTABLE = useChinese ? "导出表格" : "Export table to file";
        WANNAOVERWRITE = useChinese ? "文件已存在，您打算覆盖？" : "File already exited! OVER WRITE IT?";
        CHOOSEXLSFILE = useChinese ? "请输入您要保存的文件名" : "Choose an xls file to save the table";
